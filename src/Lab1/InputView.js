                    ...
                    <View>
                        {hide ? (
                            <TouchableOpacity onPress={hideShow}>
                                <Image source={require('../../img/icons/hidePassword.png')} style={styles.showPassword} />
                            </TouchableOpacity>
                        ) : (
                            <TouchableOpacity onPress={hideShow}>
                                <Image source={require('../../img/icons/showPassword.png')} style={styles.showPassword} />
                            </TouchableOpacity>
                        )}
                    </View>
                )}

                {!!error && <Image source={require('../../img/icons/error.png')} style={styles.showPassword} />}
            </View>
